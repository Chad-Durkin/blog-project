...
define('desktop/routes/index', ['exports', 'ember'], function (exports, _ember) {
    exports['default'] = _ember['default'].Route.extend({
        ...
        actions: {
            ...
            update3: function update3(game, params) {
...
if (!runningTests) {
  require("desktop/app")["default"].create({"name":"desktop","version":"0.0.0+67d53b8c"});
}
